...
namespace RC_Framework
{
    ...
    public class Sprite3Parent : RC_RenderableBounded
    {
        ...
        /// <summary>
        /// the z-index depth (0 to 1, near to far) of the sprite.
        /// </summary>
    ...
    /*
     * The difence between Sprite3 and sprite3 is as follows
    ...
    */
    ...
    public class Sprite3 : Sprite3Parent
    {
        ...
        /// </summary>
        public const string SpriteVersion ="V3.03";
        ...
        /// <summary>
        /// bounding Sphere Radius for user to use usually this is in screen pixels
 ...
 /// <returns>true if we got there</returns>
        ...
        public void draw(SpriteBatch sb)
        {
            ...
            {
                prepareToDraw();
                sb.Draw(tex, dest,src, getColor(), displayAngle+displayAngleOffset, rotateImage, flip, depth);

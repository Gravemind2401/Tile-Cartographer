...
namespace RC_Framework
{
    ...
    public class RC_Renderable
    {
        ...
        /// <summary>
        /// Under development to assist screen scrolling and playing areas larger than the screen
        /// Draws the renderable offset by a certain x,y value
        /// it is not available for all renderables and is specifically aimed at bounded renderables
        /// under development - confirm your renderable has been updated to support this by looking for
        /// this routine overridden
        /// 
        /// the x and y values of screenrect are used as offsets to move the sprite
        /// </summary>
        /// <param name="sb">the spritebatch</param>
        /// <param name="screenrect">the rectangle that represents the screen - no draw will be done if the sprite does not intersect this</param>
        public virtual void DrawOffset(SpriteBatch sb, Rectangle screenrect)
        {
            Draw(sb); // unhelpfull but - sensible default bad behaviour (at least you may see somthing)
        }
    ...
    public class RC_RenderableList : RC_Renderable
    {
        ...
        /// <summary>
        /// If the renderable list only contains RC_RenderableBounded it will return
        ...
        /// <summary>
        /// Checks for collision with rectangle
        /// </summary>
        /// <param name="r"></param>
        /// <returns></returns>
